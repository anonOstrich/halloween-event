...
export default async function EventPage({
  ...
  return (
    <main className="justify-center items-start gap-3 space-y-4">
      <h1 className="prose dark:prose-invert prose-2xl text-center">
        {event.title} {isPakotus && <span className="uppercase">pakotus</span>}
      </h1>
